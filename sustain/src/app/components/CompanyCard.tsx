...
export default function CompanyCard({ name, date, score }: CompanyProps) {
  return (
    <div className="flex items-center border rounded-[10px] py-6 px-4 w-[723px] h-[50px] mb-4 bg-[rgb(54,54,54)] border-[rgb(118,118,118)]">
      <span className="text-white text-[24px] w-[250px]">{name}</span>
